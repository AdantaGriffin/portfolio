        ...
        <>
            ...
            <div className='projects-container'>
                <div className='projects'>
                    <img src='./images/formAStoryImg.png'/>
                ...
                <div className='projects'>
                    <img src='./images/pianoPlayerImg.png'/>
                    <div className='project-info'>
                        <p>Piano Keys</p>
                ...
                <div className='projects'>
                    <img src='./images/NumberGuesserImg.png'/>
                    <div className='project-info'>
                        <p>Guess Closer</p>
                ...
                <div className='projects'>
                    <img src='./images/lepisGoldImg.png'/>
                    <div className='project-info'>
                        <p>Lepi's Gold</p>
                ...
                <div className='projects'>
                    <img src='./images/authorizedImg.png'/>
                    <div className='project-info'>
                        <p>Riddler</p>
                ...
                <div className='projects'>
                    <img src='./images/appointment-scheduler.png'/>
                    <div className='project-info'>
