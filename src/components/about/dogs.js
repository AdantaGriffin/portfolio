    ...
    return (
        <>
            ...
            <div className='dogs-gallery'>
                <img src='/images/IMG_6402.PNG' width='400px'/>
                <img src='/images/IMG_6403.PNG' width='400px'/>
                <img src='/images/IMG_6404.PNG' width='400px'/>
                <img src='/images/IMG_6410.PNG' width='400px'/>
                <img src='/images/IMG_6400.PNG' width='400px'/>
            </div>
            <div className='next'>
