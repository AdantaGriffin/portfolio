        ...
        <>
            ...
            <div className='skills-container'>
                <div className='skill-block'>
                    <img src='/images/html-5.png' className='skill-icon' alt=''/>
                ...
                <div className='skill-block'>
                    <img src='/images/ui-ux.png' className='skill-icon' alt=''/>
                ...
                <div className='skill-block'>
                    <img src='/images/git-bash.png' className='skill-icon' alt=''/>
